...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embeddings = nn.Parameter(torch.as_tensor(embeddings, dtype=torch.float32).clone())
    ...
    def forward(self, w):
        ...
        hidden = F.relu(x.matmul(self.embed_to_hidden_weight) + self.embed_to_hidden_bias)
