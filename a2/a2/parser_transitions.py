...
class PartialParse(object):
    ...
    def parse_step(self, transition):
        ...
        if transition == "S":
            ...
            raise ValueError("Transition must be one of 'S', 'LA', or 'RA'.")
...
def minibatch_parse(sentences, model, batch_size):
    ...
    unfinished_parses = [
        partial_parse for partial_parse in partial_parses
    ...
    while unfinished_parses:
        ...
        if len(transitions) != len(minibatch):
            raise ValueError("model.predict must return one transition per partial parse")
